...
select * from tb_produtos where nome like "%ha";
select * from  tb_produtos where nome like "%sa";
select * from  tb_produtos where nome like "%ha%";
...
select tb_produtos.nome,tb_produtos.preco,tb_produtos.qtproduto, tb_categoria.descricao from tb_produtos inner join tb_categoria 
